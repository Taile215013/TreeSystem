...
import { KeyRound, Loader2, User, Leaf } from "lucide-react";
...
export function AuthForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto mt-20 p-8 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-3xl shadow-2xl">
      <div className="flex flex-col items-center mb-8">
        <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 text-white shadow-lg shadow-emerald-500/20 mb-4">
          <Leaf className="h-6 w-6" />
        </div>
        <h2 className="text-2xl font-bold text-center tracking-tight text-white mb-2">Welcome Back</h2>
